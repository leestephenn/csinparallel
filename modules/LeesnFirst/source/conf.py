# -*- coding: utf-8 -*-
#
# LeesnFirst documentation build configuration file, created by
...
htmlhelp_basename = 'LeesnFirstdoc'
...
latex_documents = [
  ('index', 'LeesnFirst.tex', u'LeesnFirst',
...
texinfo_documents = [
  ('index', 'LeesnFirst', u'LeesnFirst Documentation',
   u'CSInParallel Project', 'LeesnFirst', 'One line description of project.',
   'Miscellaneous'),
]
